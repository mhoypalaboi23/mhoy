				...
				<ul class="nav nav-pills hidden-xs hidden-sm">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="kitchen-essential.php">KITCHEN ESSENTIALS</a></li>
							<li class="divider"></li>	
							<li class="active"><a href="air-essential.php">AIR ESSENTIALS</a></li>
							<li class="divider"></li>	
							<li><a href="home-essential.php">HOME ESSENTIALS</a></li>
							<li class="divider"></li>	
							<li><a href="health-essential.php">HEALTH ESSENTIALS</a></li>
	...
	<div id="container">
		<div class="product container">
			<ol class="breadcrumb">
				...
				<li class="active">AIR ESSENTIALS</li>
			</ol>
					...
					<div class="col-sm-6 col-md-3">
						<div class="thumbnail">
							...
							<div class="caption">
								...
								<p>Clean air is healthy air! The innovative and aesthetically designed cleaning system uses only water as a</p>
